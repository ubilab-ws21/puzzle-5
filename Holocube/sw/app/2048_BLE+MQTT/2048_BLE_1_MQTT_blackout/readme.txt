...
when there are ble and mqtt, the game number wont work, has blackout there.
I guess it could be the power can not support ble and mqtt both so the game number is not smooth at all.
so finally change to ble or mqtt as a control commands only.
please check mqtt, Ble or mpu later